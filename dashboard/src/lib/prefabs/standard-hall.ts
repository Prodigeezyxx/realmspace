...
export const standardHall: Prefab = {
  ...
  thumbnail: "data:image/svg+xml," + encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 72"><rect width="120" height="72" fill="#0a0c10"/><rect x="8" y="8" width="104" height="56" fill="none" stroke="#42faa1" stroke-width="2"/><rect x="45" y="20" width="30" height="32" fill="#3e83f733"/></svg>`
  ),
