...
export const openPlan: Prefab = {
  ...
  thumbnail: "data:image/svg+xml," + encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 72"><rect width="120" height="72" fill="${BRAND_BASE}"/><rect x="15" y="12" width="90" height="48" fill="#ffffff08" stroke="#888"/></svg>`
  ),
